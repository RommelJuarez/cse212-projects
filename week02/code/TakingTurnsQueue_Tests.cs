...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: people are not removed when turns reach 0.
    ...
    // Defect(s) Found: new player is not added in correct order 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: tim is not treated as infinite his turns decrease 
    ...
    // Defect(s) Found: negative turns are not handled as infinite correctly.
    ...
    // Defect(s) Found: no exception is thrown when queue is empty.
